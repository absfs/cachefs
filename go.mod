module github.com/absfs/cachefs

go 1.23

require github.com/absfs/absfs v0.0.0-20251208232938-aa0ca30de832

require (
	github.com/absfs/corfs v0.0.0-20251109174041-3135d202a72a
